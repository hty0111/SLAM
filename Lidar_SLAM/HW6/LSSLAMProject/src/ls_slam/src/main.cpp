...
int main(int argc, char **argv)
{
    ...
    std::string VertexPath = "/home/hty/Desktop/SLAM/Lidar_SLAM/HW6/LSSLAMProject/src/ls_slam/data/test_quadrat-v.dat";
    std::string EdgePath = "/home/hty/Desktop/SLAM/Lidar_SLAM/HW6/LSSLAMProject/src/ls_slam/data/test_quadrat-e.dat";
